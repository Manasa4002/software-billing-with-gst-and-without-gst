...
class Bill_App:
   ...
   def __init__(self,root):
        ...
        cphn_lbl=Label(F1,text="Bill No",bg=bg_color,fg="white",font=("times new roman",18,"bold")).grid(row=0,column=4,padx=20,pady=5)
        cphn_txt=Entry(F1,width=15,textvariable=self.C_phone,font="arial 10",bd=7,relief=SUNKEN).grid(row=0,column=5,pady=5,padx=10)

        Gst_lbl=Label(F1,text="GST",bg=bg_color,fg="white",font=("times new roman",18,"bold")).grid(row=0,column=6,padx=20,pady=5)
        Gst_txt=Entry(F1,width=15,textvariable=self.C_phone,font="arial 10",bd=7,relief=SUNKEN).grid(row=0,column=7,pady=5,padx=10)

        bill_btn=Button(F1,text="search",width=15,bd=7,font="arial 12 bold").grid(row=0,column=8,padx=10,pady=10)
        ...
        c1_lbl=Label(F6,text=" total cosmetic tax",bg=bg_color,fg="green",font=("times new roman",14,"bold")).grid(row=1,column=2,padx=20,pady=1,sticky="w")
        c1_txt=Entry(F6,width=18,textvariable=self.cosmetic_price,font="arial 10 bold",bd=7,relief=SUNKEN).grid(row=1,column=3,padx=10,pady=1)

        c2_lbl=Label(F6,text="Total grocery tax",bg=bg_color,fg="green",font=("times new roman",14,"bold")).grid(row=2,column=2,padx=10,pady=1,sticky="w")
        c2_txt=Entry(F6,width=18,textvariable=self.grocery_price,font="arial 10 bold",bd=7,relief=SUNKEN).grid(row=2,column=3,padx=10,pady=1)

        c3_lbl=Label(F6,text="total cool drink tax ",bg=bg_color,fg="green",font=("times new roman",16,"bold")).grid(row=3,column=2,padx=20,pady=1,sticky="w")
        c3_txt=Entry(F6,width=18,textvariable=self.cool_drink_price,font="arial 10 bold",bd=7,relief=SUNKEN).grid(row=3,column=3,padx=10,pady=1)
